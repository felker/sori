...
void generate_test_points_launcher(float* feature_points_out, float* dim_points_out, int gn_points, int gn_features, int gn_dim, float* scale, float* offset, int* important_features, int TPB, cudaStream_t* stream);
}
#endif
